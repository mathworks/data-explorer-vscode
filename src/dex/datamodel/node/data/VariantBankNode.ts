...
export default class VariantBankNode extends DataNode {
    Value: unknown;
    ...
    static parse(rawVal: Record<string, unknown>, name: string, parent: BaseNode | null): VariantBankNode { const elem = rawVal._elements && (rawVal._elements as unknown[])[0]; const props = ((elem && (elem as Record<string, unknown>)._properties) || {}) as Record<string, unknown>; const serial = { _rawVal: rawVal, _properties: props }; return new VariantBankNode(name, parent, props, serial as Record<string, unknown>); }
}
